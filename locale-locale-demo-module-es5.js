...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["locale-locale-demo-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppLocaleLocalePipeDemoHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppLocaleLocaleDemoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LocaleDemoModule", function () {
    ...
    var _locale_pipe_demo__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./locale-pipe.demo */
    "./src/app/locale/locale-pipe.demo.ts");
    /* harmony import */


    var _locale_demo_routes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./locale-demo.routes */
    "./src/app/locale/locale-demo.routes.ts");

    var LocaleDemoModule = function LocaleDemoModule() {
      _classCallCheck(this, LocaleDemoModule);
    };

    LocaleDemoModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_locale_pipe_demo__WEBPACK_IMPORTED_MODULE_5__["LocalePipeDemoComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], ids_enterprise_ng__WEBPACK_IMPORTED_MODULE_4__["SohoComponentsModule"], _locale_demo_routes__WEBPACK_IMPORTED_MODULE_6__["LocaleDemoRoutingModule"]],
      providers: [],
      bootstrap: []
    })], LocaleDemoModule);
    /***/
  ...
  /***/
  function srcAppLocaleLocaleDemoRoutesTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LocaleDemoRoutingModule", function () {
    ...
    var _locale_pipe_demo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./locale-pipe.demo */
    "./src/app/locale/locale-pipe.demo.ts");
    ...
    var LocaleDemoRoutingModule = function LocaleDemoRoutingModule() {
      _classCallCheck(this, LocaleDemoRoutingModule);
    };

    LocaleDemoRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppLocaleLocalePipeDemoTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LocalePipeDemoComponent", function () {
    ...
    var LocalePipeDemoComponent = function LocalePipeDemoComponent(formBuilder, ref, ngZone) {
      var _this = this;

      _classCallCheck(this, LocalePipeDemoComponent);
      ...
      this.model.locale = Soho.Locale.currentLocale.name; // Create the demo form, and initialise with the model data.
    ...
    LocalePipeDemoComponent.ctorParameters = function () {
      return [{
    ...
    LocalePipeDemoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-locale-pipe-demo',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./locale-pipe.demo.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/locale/locale-pipe.demo.html")).default,
